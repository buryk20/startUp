window.onload = function () {
  ...
  const nav = document.getElementById("nav"),
    lock = document.querySelector(".header__nav-wrp"),
    burger = document.querySelector(".header__burger");

  const mainCont = document.getElementById("lock"),
    modalWrp = document.querySelectorAll(".main-form__container"),
    clickBtnMod = document.querySelector(".btn-form"),
    formWrp = document.querySelector(".js-activ"),
    clickClose = document.querySelector(".main-form__form-wrp");
  console.log(modalWrp);

  const body = document.querySelector("body");

  const main = document.querySelector("main"),
    buttonIndex = document.querySelectorAll(".btn-pop-up");
  ...
  const btnContacts = document.querySelectorAll(".js-btn-contact-item"),
    contactMod = document.querySelector(".js-btn-contact"),
    contactClose = document.querySelectorAll(".js-btn-close");
